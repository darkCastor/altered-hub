...
const mockCardData = {
  ...
  'ALT_CORE_H_AX_01_C': {
    id: 'ALT_CORE_H_AX_01_C', name: 'Teija, Mage Intuitif', type: 'CHARACTER', faction: 'Axiom', rarity: 'Common'
  },
  'ALT_CORE_H_BR_01_C': {
    id: 'ALT_CORE_H_BR_01_C', name: 'Rin, Soldat Déterminé', type: 'CHARACTER', faction: 'Bravos', rarity: 'Common'
  },
  'ALT_CORE_H_LY_01_C': {
    id: 'ALT_CORE_H_LY_01_C', name: 'Sigrid, Veilleuse de Mémoire', type: 'CHARACTER', faction: 'Lyra', rarity: 'Common'
  },
  'ALT_CORE_H_MU_01_C': {
    id: 'ALT_CORE_H_MU_01_C', name: 'Kojo, Guide Spirituel', type: 'CHARACTER', faction: 'Muna', rarity: 'Common'
  },

  // Characters with same name but different transformations and factions (Rule 1.1.4 remark)
  'ALT_CORE_C_AX_01_C': {
    id: 'ALT_CORE_C_AX_01_C', name: 'Polymorphe', type: 'CHARACTER', faction: 'Axiom', rarity: 'Common'
  },
  'ALT_CORE_C_AX_01_R1': {
    id: 'ALT_CORE_C_AX_01_R1', name: 'Polymorphe', type: 'CHARACTER', faction: 'Bravos', rarity: 'Common' // Same name, different faction
  },
  'ALT_CORE_C_AX_01_R2': {
    id: 'ALT_CORE_C_AX_01_R2', name: 'Polymorphe', type: 'CHARACTER', faction: 'Lyra', rarity: 'Rare' // Same name, different faction and rarity
  },

  // Multiple rarity versions of same card
  'ALT_CORE_C_AX_02_C': {
    id: 'ALT_CORE_C_AX_02_C', name: 'Garde Versatile', type: 'CHARACTER', faction: 'Axiom', rarity: 'Common'
  },
  'ALT_CORE_C_AX_02_R': {
    id: 'ALT_CORE_C_AX_02_R', name: 'Garde Versatile', type: 'CHARACTER', faction: 'Axiom', rarity: 'Rare' // Same name/faction, different rarity
  },
  'ALT_CORE_C_AX_02_U': {
    id: 'ALT_CORE_C_AX_02_U', name: 'Garde Versatile', type: 'CHARACTER', faction: 'Axiom', rarity: 'Unique' // Same name/faction, unique rarity
  },

  // Regular cards for testing limits
  'ALT_CORE_C_AX_03_C': {
    id: 'ALT_CORE_C_AX_03_C', name: 'Soldat Axiome', type: 'CHARACTER', faction: 'Axiom', rarity: 'Common'
  },
  'ALT_CORE_C_AX_04_R': {
    id: 'ALT_CORE_C_AX_04_R', name: 'Elite Axiome', type: 'CHARACTER', faction: 'Axiom', rarity: 'Rare'
  },
  'ALT_CORE_C_AX_05_U': {
    id: 'ALT_CORE_C_AX_05_U', name: 'Champion Axiome', type: 'CHARACTER', faction: 'Axiom', rarity: 'Unique'
  },

  // Bravos cards for faction mixing tests
  'ALT_CORE_C_BR_01_C': {
    id: 'ALT_CORE_C_BR_01_C', name: 'Guerrier Bravos', type: 'CHARACTER', faction: 'Bravos', rarity: 'Common'
  },
  'ALT_CORE_C_BR_02_R': {
    id: 'ALT_CORE_C_BR_02_R', name: 'Veteran Bravos', type: 'CHARACTER', faction: 'Bravos', rarity: 'Rare'
  },

  // Lyra cards
  'ALT_CORE_C_LY_01_C': {
    id: 'ALT_CORE_C_LY_01_C', name: 'Sage Lyra', type: 'CHARACTER', faction: 'Lyra', rarity: 'Common'
  },

  // Muna cards  
  'ALT_CORE_C_MU_01_C': {
    id: 'ALT_CORE_C_MU_01_C', name: 'Druide Muna', type: 'CHARACTER', faction: 'Muna', rarity: 'Common'
  },

  // Cards without factions (edge case)
  'ALT_CORE_N_01_C': {
    id: 'ALT_CORE_N_01_C', name: 'Artefact Neutre', type: 'PERMANENT', faction: null, rarity: 'Common'
  },

  // Non-character cards
  'ALT_CORE_S_AX_01_C': {
    id: 'ALT_CORE_S_AX_01_C', name: 'Sort Axiome', type: 'SPELL', faction: 'Axiom', rarity: 'Common'
  },
  'ALT_CORE_P_AX_01_R': {
    id: 'ALT_CORE_P_AX_01_R', name: 'Monument Axiome', type: 'PERMANENT', faction: 'Axiom', rarity: 'Rare'
  }
};
...
describe('Deck Rules Edge Cases', () => {
  ...
  describe('Same Name, Different Characteristics (Rule 1.1.4 remark)', () => {
    ...
    it('should count cards with same name but different rarities toward copy limit', () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('Maximum 3 copies of "Garde Versatile" allowed (currently 4)');
    });
  ...
  describe('Boundary Conditions', () => {
    describe('Exact Limits', () => {
      it('should accept deck with exactly 39 non-Hero cards in constructed', () => {
        const cards: DeckCard[] = [
          { cardId: 'ALT_CORE_C_AX_03_C', quantity: 39 }
        ];
        const heroId = 'ALT_CORE_H_AX_01_C';
      ...
      it('should accept deck with exactly 29 non-Hero cards in limited', () => {
        ...
        const cards: DeckCard[] = [
          { cardId: 'ALT_CORE_C_AX_03_C', quantity: 29 }
        ];
        const heroId = 'ALT_CORE_H_AX_01_C';
    ...
    describe('Off-by-One Errors', () => {
      it('should reject deck with 38 non-Hero cards in constructed', () => {
        const cards: DeckCard[] = [
          { cardId: 'ALT_CORE_C_AX_03_C', quantity: 38 }
        ];
        const heroId = 'ALT_CORE_H_AX_01_C';

        const result = validator.validate(cards, heroId);
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain('A constructed deck must include at least 39 non-Hero cards (currently 38)');
      });
      ...
      it('should reject deck with 28 non-Hero cards in limited', () => {
        validator.setFormat('limited');
        const cards: DeckCard[] = [
          { cardId: 'ALT_CORE_C_AX_03_C', quantity: 28 }
        ];
        const heroId = 'ALT_CORE_H_AX_01_C';

        const result = validator.validate(cards, heroId);
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain('A limited deck must include at least 29 non-Hero cards (currently 28)');
      });
      ...
      it('should reject limited deck with 4 factions', () => {
        ...
        const result = validator.validate(cards);
        expect(result.isValid).toBe(false);
        expect(result.errors).toContain('Maximum 3 factions allowed in limited format (currently 4: Axiom, Bravos, Lyra, Muna)');
      });
    });
  });
  ...
  describe('State Machine Integration Edge Cases', () => {
    ...
    it('should handle rapid format switching with validation', () => {
      ...
      expect(snapshot.context.validationResult?.errors.some(e => e.includes('copies'))).toBe(true);
      ...
      expect(snapshot.context.validationResult?.errors.filter(e => e.includes('copies')).length).toBe(0);
    ...
    it('should handle edge case of hero changing with existing cards', () => {
      ...
      expect(snapshot.context.validationResult?.errors.some(e => e.includes('Axiom') && e.includes('Bravos'))).toBe(true);
    });
  });
