...
export class EffectProcessor {
	...
	private async resolveEffectStep(
		...
		if (step.isOptional && !this.shouldExecuteOptionalEffect(step)) {
			...
			// TODO: Determine if a return is needed here or if it should proceed to other logic
			return; // Assuming optional effects that are skipped should indeed stop further processing in this step
		}

		// Actual processing logic for the step starts here
		console.log(
